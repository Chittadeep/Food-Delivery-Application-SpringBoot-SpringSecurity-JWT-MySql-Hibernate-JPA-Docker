...
public class RiderRatingController {
    ...
    {
        return new ResponseEntity<List<RiderRating>>(riderRatingService.getRiderRatingByUserId(userId), HttpStatus.OK);
    }
    ...
    @PatchMapping(path = "/riderRating/complete")
    public ResponseEntity<RiderRating> completeRiderRating(@RequestParam int riderRatingId, @RequestParam int rating)
    {
        return new ResponseEntity<RiderRating>(riderRatingService.completeRiderRating(riderRatingId, rating), HttpStatus.ACCEPTED);
    }
