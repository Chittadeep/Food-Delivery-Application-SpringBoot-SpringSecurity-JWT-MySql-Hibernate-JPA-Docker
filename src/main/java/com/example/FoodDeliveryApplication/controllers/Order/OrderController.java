...
public class OrderController {
    ...
    ResponseEntity<List<OrderCustom>> getAllOrderForAdmin()
    {
    ...
    ResponseEntity<List<OrderCustom>> getOrderCustomByResturantId(@PathVariable int resturantId)
    {
    ...
    ResponseEntity<List<OrderCustom>> getOrderCustomByUserId(@PathVariable int userId)
    {
        return new ResponseEntity<List<OrderCustom>>(orderService.getOrderCustomByUserId(userId), HttpStatus.OK);
    }

    @PostMapping(path="/Order")
    ResponseEntity<OrderCustom> createOrder(@RequestBody OrderCustom order)
    {
